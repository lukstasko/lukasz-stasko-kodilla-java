...
public class CrudAppTestSuite {
    private static final String BASE_URL="https://lukstasko.github.io/";
    ...
    private boolean checkTaskExistInTrello(String taskName) throws InterruptedException {
        ...
        driverTrello.findElement(By.id("user")).sendKeys("lukstasko@gmail.com");
        WebElement el = driverTrello.findElement(By.id("login"));
        el.submit();
        Thread.sleep(5000);
        driverTrello.findElement(By.id("password")).sendKeys("password123");
        WebElement logSubmit = driverTrello.findElement(By.id("login-submit"));
        logSubmit.submit();
